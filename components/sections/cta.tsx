    ...
    return(
        <div className='flex bg-[#5F248E] p-6 items-center justify-center'>
            ...
            <div className='flex-col '>
               ...
               <div className='p-2 rounded-full w-[150px] bg-[#EC3D28] sm:mx-0 mx-auto text-white text-center font-bold text-base sm:text-xl'><a href='https://wa.me/919952237700?text=Hello%2C%20how%20can%20I%20help%20you%3F'>Order now</a></div>
            </div>
        </div>
    )
}
