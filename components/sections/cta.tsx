    ...
    return(
        <div className='flex bg-[#5F248E] p-6 items-center justify-center'>
            ...
            <div className='flex-col '>
               ...
               <div className='p-2 rounded-full w-[150px] bg-[#EC3D28] sm:mx-0 mx-auto text-white text-center font-bold text-base sm:text-xl'><a href='#pricing'>Get it now!</a></div>
            </div>
        </div>
    )
}
